...
const ServicesPage = () => {
  ...
  return (
    <>
      <SEO
        title="Services - Dance, Yoga, Zumba & Aerobics Classes"
        description="Explore our wellness programs in Mumbai: Contemporary Dance, Hatha Yoga, High-Energy Zumba, Step Aerobics. All levels welcome. First class free!"
        keywords="dance yoga zumba classes Mumbai, wellness services Mumbai, fitness programs, contemporary dance, hatha yoga, zumba fitness, aerobics classes"
        canonical="/services"
        schema={{
          "@context": "https://schema.org",
          "@type": "ItemList",
          name: "Harmony Studio Services",
          description:
            "Dance, Yoga, Zumba, and Aerobics classes offered at Harmony Studio",
          url: "https://www.harmonystudio.co.in/services",
        }}
      />
          ...
          <div className="container-custom relative z-10">
            <div className="max-w-3xl">
              ...
              <h1 className="text-5xl md:text-6xl font-bold text-white !mb-6">
                Three Paths to <span className="gradient-text">Wellness</span>
              </h1>
              <p className="text-xl text-gray-400 leading-relaxed">
                Whether you seek the grace of dance, the peace of yoga, or the
                energy of Zumba — we have a practice that resonates with your
                spirit.
              </p>
            </div>
          </div>

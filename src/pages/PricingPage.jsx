...
const PricingPage = () => {
  const faqs = [
    {
      ...
      answer:
        "Absolutely! We offer a complimentary first class for all new members. Just book through our contact page or walk in.",
    },
    {
      question: "What's included in the Unlimited plan?",
      answer:
        "You get unlimited access to all Dance, Yoga, and Zumba classes, priority booking, guest passes, and locker access.",
    },
    {
      question: "Can I freeze my membership?",
      answer:
        "Yes, you can pause your membership for up to 30 days per year at no extra cost.",
    },
    {
      question: "Do you offer corporate packages?",
      answer:
        "We provide customized corporate wellness programs. Contact us for a tailored quote for your organization.",
    },
  ];
  ...
  return (
    <>
      <SEO
        title="Pricing & Membership Plans - Affordable Fitness"
        description="Affordable fitness plans from ₹1,999/month at Harmony Studio Mumbai. Unlimited dance, yoga, zumba classes. First class free. View pricing & join today!"
        keywords="harmony studio pricing, gym membership Mumbai, yoga class price, dance class fees Mumbai, zumba membership, fitness packages Mumbai"
        canonical="/pricing"
        schema={{
          "@context": "https://schema.org",
          "@type": "PriceSpecification",
          name: "Harmony Studio Memberships",
          description:
            "Flexible membership plans for dance, yoga, and zumba classes",
          url: "https://www.harmonystudio.co.in/pricing",
        }}
      />
        ...
        <section className="relative !pt-32 !pb-20 bg-black overflow-hidden">
          ...
          <div className="container-custom relative z-10 text-center">
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              Invest in yourself with plans designed to fit every lifestyle and
              budget. No hidden fees, no long-term contracts.
            </p>
          </div>
        </section>
                ...
                <thead>
                  <tr className="border-b border-white/10">
                    ...
                    {PRICING.map((plan) => (
                      <th
                        key={plan.name}
                        className={`text-center !py-4 !px-4 font-bold ${plan.highlighted ? "text-[#F5A623]" : "text-white"}`}
                      >
                        {plan.name}
                      </th>
                    ))}
                ...
                <tbody>
                  {[
                    ...
                    },
                    {
                      ...
                      values: [false, false, "1/month"],
                    },
                    { feature: "VIP Events", values: [false, false, true] },
                    {
                      feature: "Retreat Discounts",
                      values: [false, false, "25% off"],
                    },
                  ].map((row, index) => (
                    <tr
                      key={index}
              ...
              {faqs.map((faq, index) => (
                ...
                >
                  <div className="flex items-start">
                    <HelpCircle
                      size={20}
                      className="text-[#F5A623] !mr-4 !mt-1 shrink-0"
                    />
                    <div>

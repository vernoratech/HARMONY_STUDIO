                ...
                <div className="container-custom relative z-10">
                    <div className="max-w-2xl">
                        ...
                        <p className="text-xl text-gray-400">
                            Have questions about our classes or membership? We're here to help you take the first step.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="container-custom">
                    <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
                        ...
                        <div>
                            ...
                            <div className="space-y-8 !mb-12">
                                <div className="flex items-start group">
                                    <div className="w-14 h-14 rounded-2xl bg-white/5 flex items-center justify-center !mr-6 shrink-0 group-hover:bg-[#F5A623] transition-colors">
                                        <MapPin size={24} className="text-[#F5A623] group-hover:text-black transition-colors" />
                                    </div>
                                    <div>
                                        <h4 className="font-bold text-white !mb-1">Visit Our Studio</h4>
                                ...
                                <div className="flex items-start group">
                                    <div className="w-14 h-14 rounded-2xl bg-white/5 flex items-center justify-center !mr-6 shrink-0 group-hover:bg-[#F5A623] transition-colors">
                                        <Phone size={24} className="text-[#F5A623] group-hover:text-black transition-colors" />
                                    </div>
                                    <div>
                                        <h4 className="font-bold text-white !mb-1">Call Us</h4>
                                        <a href={`tel:${CONTACT_INFO.phone}`} className="text-gray-400 hover:text-[#F5A623] transition-colors">
                                            {CONTACT_INFO.phone}
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start group">
                                    <div className="w-14 h-14 rounded-2xl bg-white/5 flex items-center justify-center !mr-6 shrink-0 group-hover:bg-[#F5A623] transition-colors">
                                        <Mail size={24} className="text-[#F5A623] group-hover:text-black transition-colors" />
                                    </div>
                                    <div>
                                        <h4 className="font-bold text-white !mb-1">Email Us</h4>
                                        <a href={`mailto:${CONTACT_INFO.email}`} className="text-gray-400 hover:text-[#F5A623] transition-colors">
                                            {CONTACT_INFO.email}
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start group">
                                    <div className="w-14 h-14 rounded-2xl bg-white/5 flex items-center justify-center !mr-6 shrink-0 group-hover:bg-[#F5A623] transition-colors">
                                        <Clock size={24} className="text-[#F5A623] group-hover:text-black transition-colors" />
                                    </div>
                                    <div>
                                        <h4 className="font-bold text-white !mb-1">Studio Hours</h4>
                                        <p className="text-gray-400">
                                            Weekdays: {CONTACT_INFO.hours.weekdays}<br />
                            ...
                            {/* Map Placeholder */}
                            <div className="bg-[#1A1A1A] rounded-2xl overflow-hidden h-64 relative border border-white/10">
                                <div className="absolute inset-0 flex items-center justify-center text-gray-500">
                                    <div className="text-center">
                                        <MapPin size={48} className="mx-auto !mb-4 text-[#F5A623]/50" />
                                        <p>Interactive Map</p>
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                ...
                                                >
                                                    ...
                                                    <option value="membership" className="bg-[#1A1A1A]">General Membership</option>
                                                </select>
                                            </div>
                                        </div>
                ...
                <div className="container-custom">
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="bg-white/5 rounded-2xl !p-8 text-center hover:bg-white/10 transition-colors border border-white/5">
                            ...
                            <h4 className="text-lg font-bold text-white !mb-2">Book a Trial</h4>
                            <p className="text-gray-500 text-sm !mb-4">Experience your first class free</p>
                            <a href="#" className="text-[#F5A623] font-semibold text-sm">Book Now →</a>
                        </div>
                        <div className="bg-white/5 rounded-2xl !p-8 text-center hover:bg-white/10 transition-colors border border-white/5">
                            <div className="w-16 h-16 rounded-2xl bg-[#F5A623]/10 flex items-center justify-center mx-auto !mb-4">
                            ...
                            <p className="text-gray-500 text-sm !mb-4">Speak with our wellness advisor</p>
                            <a href="#" className="text-[#F5A623] font-semibold text-sm">Schedule →</a>
                        </div>
                        <div className="bg-white/5 rounded-2xl !p-8 text-center hover:bg-white/10 transition-colors border border-white/5">
                            <div className="w-16 h-16 rounded-2xl bg-[#F5A623]/10 flex items-center justify-center mx-auto !mb-4">
                                <MapPin size={28} className="text-[#F5A623]" />
                            </div>
                            <h4 className="text-lg font-bold text-white !mb-2">Visit Studio</h4>
                            <p className="text-gray-500 text-sm !mb-4">Take a tour of our facility</p>
                            <a href="#" className="text-[#F5A623] font-semibold text-sm">Get Directions →</a>
                        </div>
                    </div>
                </div>
            </section>

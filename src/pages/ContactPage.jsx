...
const ContactPage = () => {
  ...
  return (
    <>
      <SEO
        title="Contact Us - Book Your Free Trial Class in Mumbai"
        ...
        schema={{ 
          ...
          description:
            "Get in touch with Harmony Studio to book your trial class",
          url: "https://www.harmonystudio.co.in/contact",
          mainEntity: {
            "@type": "LocalBusiness",
            name: "Harmony Studio",
            ...
            address: {
              "@type": "PostalAddress",
              streetAddress: "Wellness Boulevard",
          ...
          <div className="container-custom relative z-10">
            <div className="max-w-2xl">
              ...
              <p className="text-xl text-gray-400">
                Have questions about our classes or membership? We're here to

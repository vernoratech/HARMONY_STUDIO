...
const GalleryPage = () => {
  ...
  return (
    <>
      <SEO
        title="Studio Gallery - Photos & Videos"
        description="Browse our dance, yoga, zumba class photos and studio videos. See our state-of-the-art facilities, vibrant classes in Mumbai. View action shots and facility tours."
        keywords="harmony studio gallery, dance class photos Mumbai, yoga studio images, zumba class pictures, fitness center gallery, studio photos Mumbai"
        canonical="/gallery"
        schema={{
          "@context": "https://schema.org",
          "@type": "ImageGallery",
          name: "Harmony Studio Gallery",
          description:
            "Photos and videos from our dance, yoga, and zumba classes",
          url: "https://www.harmonystudio.co.in/gallery",
        }}
      />
      <div className="animate-fade-in bg-[#0A0A0A] overflow-x-hidden">
        {/* PAGE HEADER */}
        <section className="relative !pt-40 !pb-24 bg-black overflow-hidden">
          ...
          <div className="container-custom relative z-10 text-center">
            ...
            >
              Experience the raw energy, focused stillness, and vibrant
              community of Harmony Studio through our curated collection of
              moments.
            </p>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-2 gap-20 items-center">
              <div className="relative">
                ...
                <p className="text-gray-400 text-lg leading-relaxed mb-10! max-w-xl">
                  From our sun-drenched yoga shala to our high-octane dance
                  halls, every corner of Harmony Studio is built with your
                  experience in mind.
                </p>
        ...
        <section className="py-32! bg-black relative overflow-hidden">
          ...
          <div className="container-custom relative z-10 text-center max-w-3xl">
            ...
            <p className="text-gray-400 !mb-12 text-xl leading-relaxed">
              Beyond the lens lies a community of movers, dreamers, and
              achievers. Your first session is where your own transformation
              story begins.
            </p>

...
const AboutPage = () => {
  return (
    <>
      <SEO
        title="About Us - Premier Wellness Center in Mumbai"
        description="Since 2018, Harmony Studio has transformed 5000+ lives in Mumbai. Meet our expert dance, yoga, and zumba instructors. Discover why we're Mumbai's #1 choice for wellness."
        keywords="about harmony studio, dance studio Mumbai history, yoga instructors Mumbai, certified fitness trainers, wellness center Mumbai, best dance teachers"
        canonical="/about"
        schema={{
          "@context": "https://schema.org",
          "@type": "AboutPage",
          name: "About Harmony Studio Mumbai",
          description:
            "Learn about Mumbai's premier dance, yoga, and zumba studio",
          url: "https://www.harmonystudio.co.in/about",
        }}
      />
      <div className="animate-fade-in">
        ...
        <section className="relative pt-32! pb-24! bg-black overflow-hidden">
          ...
          <div className="container-custom relative z-10 text-center">
            ...
            >
              Founded in 2022, Harmony Studio was born from a simple belief:
              that movement is medicine, and everyone deserves access to
              transformative wellness experiences. We are more than a fitness
              space; we are a community dedicated to the art of being well.
            </p>
          </div>
        </section>

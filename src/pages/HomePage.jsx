...
const HomePage = () => {
  return (
    <>
      <SEO
        title="Home"
        description="Join Mumbai's top-rated dance, yoga, and zumba studio. Expert instructors, flexible schedules, 150+ weekly classes. First class free! Book your free trial today at Harmony Studio."
        keywords="dance classes Mumbai, yoga studio Mumbai, zumba classes near me, fitness classes Mumbai, dance studio near me, yoga classes near me, aerobics Mumbai, wellness studio Mumbai, best gym Mumbai, contemporary dance classes, hatha yoga Mumbai"
        canonical="/"
        schema={{
          "@context": "https://schema.org",
          "@type": "WebPage",
          name: "Harmony Studio Mumbai - Dance, Yoga & Zumba Classes",
          description:
            "Premier wellness studio in Mumbai offering dance, yoga, zumba, and aerobics classes",
        ...
        <section className="relative min-h-screen flex items-center overflow-hidden bg-black">
          ...
          <div className="container-custom relative z-10 pt-32! pb-20!">
            <div className="max-w-3xl">
              ...
              >
                Experience the harmony of Dance, Yoga, and Zumba at Mumbai's
                most inspiring wellness studio. Transform your body, elevate
                your mind.
              </p>
                ...
                <div className="space-y-8 mt-10!">
                  ...
                  <div className="flex items-start group">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm leading-relaxed">
                        Over 30+ weekly classes from early morning to late
                        evening - find your perfect time.
                      </p>
                    </div>
                  </div>

    ...
    return (
        <div className="animate-fade-in">
            ...
            <section className="relative min-h-screen flex items-center overflow-hidden bg-black">
                ...
                <div className="absolute bottom-1/4 left-1/3 w-64 h-64 bg-[#F5A623]/5 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
                ...
                <div className="container-custom relative z-10 !pt-32 !pb-20">
                    <div className="max-w-3xl">
                        ...
                        {/* Subheading */}
                        <p className="text-xl text-gray-300 !mb-10 leading-relaxed max-w-xl animate-slide-left" style={{ animationDelay: '0.2s' }}>
                            Experience the harmony of Dance, Yoga, and Zumba at Mumbai's most inspiring wellness studio.
            ...
            <section className="section-padding bg-[#0A0A0A]">
                <div className="container-custom">
                    ...
                    <div className="text-center !mt-16">
                        <Link to="/schedule" className="btn btn-outline inline-flex items-center">
                            View Full Schedule
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-4">
                                <img
                                    ...
                                    alt="Yoga Class"
                                    className="rounded-2xl w-full h-48 object-cover hover-scale"
                                />
                                <img
                                    src="https://images.unsplash.com/photo-1524594152303-9fd13543fe6e?auto=format&fit=crop&q=80&w=600"
                                    alt="Zumba Class"
                                    className="rounded-2xl w-full h-64 object-cover hover-scale"
                                />
                            </div>
                            ...
                            <div className="space-y-6 !mt-10">
                                <div className="flex items-start group">
                                    <div className="w-14 h-14 rounded-2xl bg-[#F5A623]/10 flex items-center justify-center !mr-5 shrink-0 group-hover:bg-[#F5A623] group-hover:text-black transition-all">
                                        <Users size={24} className="text-[#F5A623] group-hover:text-black transition-colors" />
                                    </div>
                                    <div>
                                        <h4 className="text-lg font-bold text-gray-900 !mb-2">Expert Instructors</h4>
                                        <p className="text-gray-600 text-sm leading-relaxed">
                                            Learn from certified professionals with years of experience and a passion for teaching.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start group">
                                    <div className="w-14 h-14 rounded-2xl bg-[#F5A623]/10 flex items-center justify-center !mr-5 shrink-0 group-hover:bg-[#F5A623] group-hover:text-black transition-all">
                                        <Calendar size={24} className="text-[#F5A623] group-hover:text-black transition-colors" />
                                    </div>
                                    <div>
                                        <h4 className="text-lg font-bold text-gray-900 !mb-2">Flexible Scheduling</h4>
                                        <p className="text-gray-600 text-sm leading-relaxed">
                                            Over 150 weekly classes from early morning to late evening - find your perfect time.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start group">
                                    <div className="w-14 h-14 rounded-2xl bg-[#F5A623]/10 flex items-center justify-center !mr-5 shrink-0 group-hover:bg-[#F5A623] group-hover:text-black transition-all">
                                        <Award size={24} className="text-[#F5A623] group-hover:text-black transition-colors" />
                                    </div>
                                    <div>
                                        <h4 className="text-lg font-bold text-gray-900 !mb-2">Award-Winning Programs</h4>
                                        <p className="text-gray-600 text-sm leading-relaxed">
                                            Recognized for excellence in wellness education and community impact.
                                        </p>
                                    </div>
                                </div>
                            </div>

                            <Link to="/about" className="btn btn-primary !mt-10 inline-flex items-center">
                                Learn More About Us
                                <ArrowRight size={18} className="!ml-2" />
                            </Link>
                        </div>
                ...
                <div className="container-custom">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {TESTIMONIALS.map((testimonial, index) => (
                            <div
                                key={index}
                                className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl !p-8 hover:border-[#F5A623]/30 transition-all hover-lift"
                            >
                                {/* Stars */}
                                ...
                                <div className="flex items-center">
                                    <img
                                        ...
                                        className="w-12 h-12 rounded-full object-cover !mr-4 border-2 border-[#F5A623]/30"
                                    />
                                    <div>
            ...
            <section className="!py-24 relative overflow-hidden">
                ...
                <div className="container-custom relative z-10 text-center">
                    ...
                    <p className="text-black/70 text-lg !mb-10 max-w-2xl mx-auto">
                        Join thousands of members who have discovered the transformative power of movement.

...
const SchedulePage = () => {
  ...
  return (
    <>
      <SEO
        title="Class Schedule - 150+ Weekly Classes in Mumbai"
        description="View this week's dance, yoga, zumba class schedule at Harmony Studio Mumbai. Morning yoga at 7 AM, evening Zumba at 6 PM. Book your spot today!"
        keywords="harmony studio schedule, class timings Mumbai, yoga class schedule, dance class times, zumba timetable Mumbai, weekly schedule"
        canonical="/schedule"
        schema={{
          "@context": "https://schema.org",
          "@type": "Schedule",
          name: "Harmony Studio Class Schedule",
          description: "Weekly schedule of dance, yoga, and zumba classes",
          url: "https://www.harmonystudio.co.in/schedule",
        }}
      />
        ...
        <section className="relative !pt-32 !pb-20 bg-black overflow-hidden">
          ...
          <div className="container-custom relative z-10 text-center">
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              Over 150 classes weekly. From sunrise sessions to evening flows —
              there's always a perfect class waiting for you.
            </p>
          </div>
        </section>
                    ...
                    >
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        ...
                        <div className="flex items-start gap-6">
                          ...
                          <div>
                            ...
                            <div className="flex flex-wrap items-center gap-4 text-sm text-gray-500">
                              ...
                              <span
                                className={`!px-2 !py-0.5 rounded border ${colors.border} ${colors.text} text-xs`}
                              >
                                {slot.level}
                              </span>
                            </div>
                        ...
                        <button className="!px-6 !py-2.5 bg-white/5 text-white border border-white/10 rounded-full font-semibold text-sm hover:bg-[#F5A623] hover:text-black hover:border-[#F5A623] transition-all flex items-center justify-center group/btn gap-2">
                          ...
                          <ArrowRight
                            size={16}
                            className="!ml-2 -translate-x-2 group-hover/btn:translate-x-0 transition-all"
                          />
                        </button>
                      </div>
                    </div>
              ...
              {["Yoga", "Zumba", "Dance"].map((type) => {
                ...
                return (
                  <div key={type} className="flex items-center">
                    <div
                      className={`w-3 h-3 rounded-full !mr-2 ${colors.bg} ${colors.text}`}
                      style={{
                        backgroundColor:
                          type === "Yoga"
                            ? "#22c55e"
            ...
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div className="!p-8">
                ...
                <p className="text-gray-500 text-sm">
                  Start your day right with our 6:30 AM sessions
                </p>
              </div>
              <div className="!p-8">
                <div className="w-16 h-16 rounded-2xl bg-[#F5A623]/10 flex items-center justify-center mx-auto !mb-4">
